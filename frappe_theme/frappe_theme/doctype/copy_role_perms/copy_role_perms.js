...
frappe.ui.form.on("Copy Role Perms", {
	refresh(frm) {
		...
		// Bulk operations
		frm.add_custom_button(__("Select All"), () => toggle_all_perms(frm, true), __("Bulk Actions"));
		frm.add_custom_button(__("Deselect All"), () => toggle_all_perms(frm, false), __("Bulk Actions"));
		frm.add_custom_button(__("Enable Read"), () => set_bulk_perms(frm, {read: 1}), __("Bulk Actions"));
		frm.add_custom_button(__("Enable Write"), () => set_bulk_perms(frm, {write: 1}), __("Bulk Actions"));
		frm.add_custom_button(__("Enable Read & Write"), () => set_bulk_perms(frm, {read: 1, write: 1}), __("Bulk Actions"));
		
		// Quick Presets
		frm.add_custom_button(__("Read Only"), () => apply_preset(frm, "read_only"), __("Quick Presets"));
		frm.add_custom_button(__("Full Access"), () => apply_preset(frm, "full_access"), __("Quick Presets"));
		frm.add_custom_button(__("Report Only"), () => apply_preset(frm, "report_only"), __("Quick Presets"));
		frm.add_custom_button(__("Data Entry"), () => apply_preset(frm, "data_entry"), __("Quick Presets"));
...
function apply_preset(frm, preset) {
	const presets = {
		read_only: {read: 1, write: 0, create: 0, delete_to: 0, submit_to: 0, cancel_to: 0, amend: 0, report: 0, export: 0, share: 0, print: 0, email: 0, select: 0, import_to: 0},
		full_access: {read: 1, write: 1, create: 1, delete_to: 1, submit_to: 1, cancel_to: 1, amend: 1, report: 1, export: 1, share: 1, print: 1, email: 1, select: 1, import_to: 1},
		report_only: {read: 1, write: 0, create: 0, delete_to: 0, submit_to: 0, cancel_to: 0, amend: 0, report: 1, export: 1, share: 0, print: 1, email: 0, select: 0, import_to: 0},
		data_entry: {read: 1, write: 1, create: 1, delete_to: 0, submit_to: 0, cancel_to: 0, amend: 0, report: 1, export: 1, share: 0, print: 1, email: 1, select: 0, import_to: 0}
	};
