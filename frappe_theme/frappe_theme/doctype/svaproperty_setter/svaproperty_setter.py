		...
		try:
			...
			if self.get("masking"):
				config["masking"] = {
					...
					"list_view": 1 if self.get("list_view") else 0,
					"form_view": 1 if self.get("form_view") else 0,
					"reports": 1 if self.get("reports") else 0,
					"api_response": 1 if self.get("api_response") else 0,
