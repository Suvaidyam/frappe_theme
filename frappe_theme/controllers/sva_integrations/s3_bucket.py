...
def file_upload_to_s3(doc, method):
	...
	if parent_doctype not in ignore_s3_upload_for_doctype:
		...
		if doc.is_private:
			method = "frappe_theme.controllers.sva_integrations.s3_bucket.generate_file"
...
def s3_file_regex_match(file_url):
	...
	"""
	return re.match(
		r"^(https:|/api/method/frappe_theme.controllers.sva_integrations.s3_bucket.generate_file)", file_url
	)
