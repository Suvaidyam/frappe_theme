	...
	setup(props) {
		...
		const messageHandler = (e) => {
			...
			try {
				...
				if (
					data &&
					(data.type === "dynamic-html:resize" || data.type === "resize") &&
					data.height
				) {
