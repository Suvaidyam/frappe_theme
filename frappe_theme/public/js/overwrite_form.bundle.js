			...
			case "Number Card": {
				if (field.sva_ft.number_card) {
					...
					let item = {
						...
						number_card_filters: field.sva_ft.number_card_filters || null,
						number_card_document_type: field.sva_ft.number_card_document_type || null,
						redirect_filters: field.sva_ft.redirect_filters || null,
