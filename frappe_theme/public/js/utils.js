		...
		if (toggle) {
			...
			if (isDialog && context?.show_message) {
				if (context?.header) {
					...
					// append fresh error message
					$header.append(`
						<div id="sva-dt-error-message" style="display: flex; align-items: center; gap: 4px; margin-top: 4px; padding: 0px 10px; background: #fef2f2; border-left: 3px solid #ef4444; border-radius: 4px; font-size: 13px; color: #991b1b; animation: slideDown 0.3s ease;">
							<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" style="color: #ef4444; flex-shrink: 0;">
								<path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
							</svg>
							<div class="form-message border-bottom red">${__(message)}</div>
						</div>
					`);
				} else {
