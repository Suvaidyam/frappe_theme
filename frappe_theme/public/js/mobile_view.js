					...
					.map((field) => {
						const value =
							field.fieldtype === "Link"
								? doc[
										Object.entries(doc).find(([key]) =>
											key.startsWith(`${field.fieldname}_`)
										)?.[0] || field.fieldname
								  ]
								: doc[field.fieldname];
						return `<div style="color:${
							theme.table_body_text_color
								? theme.table_body_text_color + " !important"
								: "black"
						};"><strong style="color:${
							theme.table_head_text_color
								? theme.table_head_text_color + " !important"
								: "black"
						} !important;">${frappe.model.unscrub(field.label)}:</strong> ${
							value || "----"
						}</div>`;
					})
					.join("");
					...
					return `
                        <div class="list-row-container" tabindex="1">
                            <div class="level list-row" style="align-items: center;">
                                ...
                                <div class="level-right text-muted ellipsis" style="color:${
									theme.table_head_text_color
										? theme.table_head_text_color
										: "black"
								};">
