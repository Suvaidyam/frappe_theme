...
<sub>Detailed technical documentation with API reference, configuration options, and development guide</sub>
...
<sub>Get started in 5 minutes with installation, setup, and common use cases</sub>
...
<sub>Complete feature list (200+) with statistics and use cases</sub>
...
| ⚙️ | Configuration options | Best practices included |
| 🛠️ | Development guide | Contribution guidelines |
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
<tr>
<td style="width: 50%; vertical-align: top; padding: 20px; border: 1px solid #30363d;">
...
| 🔌 Field Overrides | Link, Select, Multiselect, Date |
| 📋 Datatables | Filtering, sorting, bulk actions |
...
| Component | Details |
|:---|:---|
| 📦 40+ DocTypes | Config, permissions, workflow |
...
| ⬆️ `pyupgrade` | Python syntax upgrades |
...
<sub>Theme, workspace, datatable, permission, workflow, approval, and more</sub>
...
<sub>Vue components, UI elements, field overrides, datatable system</sub>
...
<sub>India state & district boundaries in GeoJSON format</sub>
...
<sub>Theme, Export, Approval, AI Integration, Meta APIs</sub>
